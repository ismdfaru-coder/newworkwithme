  ...
  return (
    ...
    >
      ...
      <div className="border-t border-border p-2">
        {!collapsed && (
          <div className="mb-2 cursor-pointer rounded-lg bg-muted/50 p-3 transition-colors hover:bg-muted">
            <div className="flex items-center gap-2">
              <RocketIcon />
              <span className="flex-1 text-sm font-medium">Share WorkwithMe with a friend</span>
              <ChevronRight className="h-4 w-4 text-muted-foreground" />
            </div>
            <p className="mt-1 pl-6 text-xs text-muted-foreground">Get 500 credits each</p>
          </div>
        )}
