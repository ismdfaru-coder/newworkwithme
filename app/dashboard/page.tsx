  ...
  return (
    <div className="flex h-full flex-col items-center justify-center px-4">
      ...
      <div className="w-full max-w-3xl">
        ...
        {/* Customize AI Agent Card */}
        <Card className="mx-auto mt-8 max-w-xl cursor-pointer border-border transition-colors hover:border-primary/50">
          <CardContent className="flex items-center gap-6 p-6">
            <div className="flex-1">
              <h3 className="font-semibold">Customize your AI agent for your business</h3>
            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="flex items-center gap-1">
                <div className="flex h-6 w-6 items-center justify-center rounded-full bg-[#0088cc]">
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="white">
                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.64 6.8c-.15 1.58-.8 5.42-1.13 7.19-.14.75-.42 1-.68 1.03-.58.05-1.02-.38-1.58-.75-.88-.58-1.38-.94-2.23-1.5-.99-.65-.35-1.01.22-1.59.15-.15 2.71-2.48 2.76-2.69a.2.2 0 00-.05-.18c-.06-.05-.14-.03-.21-.02-.09.02-1.49.95-4.22 2.79-.4.27-.76.41-1.08.4-.36-.01-1.04-.2-1.55-.37-.63-.2-1.12-.31-1.08-.66.02-.18.27-.36.74-.55 2.92-1.27 4.86-2.11 5.83-2.51 2.78-1.16 3.35-1.36 3.73-1.36.08 0 .27.02.39.12.1.08.13.19.14.27-.01.06.01.24 0 .37z"/>
                  </svg>
                </div>
                <div className="flex h-6 w-6 items-center justify-center rounded-full bg-gradient-to-br from-[#00B2FF] to-[#006AFF]">
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="white">
                    <path d="M12 2C6.36 2 2 6.13 2 11.7c0 2.91 1.19 5.44 3.14 7.17.16.13.26.35.27.57l.05 1.78c.04.57.61.94 1.13.71l1.98-.87c.17-.08.36-.1.55-.06.91.25 1.87.38 2.88.38 5.64 0 10-4.13 10-9.7C22 6.13 17.64 2 12 2zm5.89 7.73l-2.91 4.62c-.46.74-1.46.92-2.15.39l-2.32-1.74a.55.55 0 00-.66 0L7.1 15.13c-.31.23-.72-.13-.52-.46l2.91-4.62c.46-.74 1.46-.92 2.15-.39l2.32 1.74c.2.15.47.15.66 0l2.75-2.09c.31-.23.72.13.52.42z"/>
                  </svg>
                </div>
              </div>
              ...
              {/* WorkwithMe card preview */}
              <div className="mt-1 flex items-center gap-1 rounded-md bg-background p-1.5 text-[8px] shadow-sm border border-border">
                <span className="font-medium">WorkwithMe</span>
                <svg width="8" height="8" viewBox="0 0 24 24" fill="#0088cc">
